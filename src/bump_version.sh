...
sed -i '' "s/CURRENT_PROJECT_VERSION = $current_version/CURRENT_PROJECT_VERSION = $new_version/g" $p_file
...
sed -i '' "s/MARKETING_VERSION = $current_version_name/MARKETING_VERSION = $new_version_name/g" $p_file
